...
longevity of your vehicle. From oil changes</p>
      ...
      {/* Footer Section */}
      <footer className="bg-black text-white py-[60px] px-[50px]">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <img src="https://themehealer.com/php-template/crank-php/assets/images/resources/logo-1.png" alt="Logo" className="mb-4"/>
            <p className="text-gray-400 mb-4">Professional car service and maintenance for all vehicle types. Your trusted automotive partner.</p>
            <div className="flex space-x-3">
              <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-red-600">f</div>
              <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-red-600">t</div>
              <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-red-600">i</div>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white">Oil Change</a></li>
